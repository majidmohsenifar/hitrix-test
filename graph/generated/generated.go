...
func (ec *executionContext) field_Query_products_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
	args := map[string]interface{}{}
	var arg0 *model.ProductListInput
	if tmp, ok := rawArgs["input"]; ok {
		ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("input"))
		arg0, err = ec.unmarshalOProductListInput2ᚖhitrixᚑtestᚋgraphᚋmodelᚐProductListInput(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Query_products(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().Products(rctx, args["input"].(*model.ProductListInput))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) unmarshalInputProductListInput(ctx context.Context, obj interface{}) (model.ProductListInput, error) {
	var it model.ProductListInput
	asMap := map[string]interface{}{}
	for k, v := range obj.(map[string]interface{}) {
		asMap[k] = v
	}
...
func (ec *executionContext) marshalNProduct2ᚕᚖhitrixᚑtestᚋgraphᚋmodelᚐProduct(ctx context.Context, sel ast.SelectionSet, v []*model.Product) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalOProduct2ᚖhitrixᚑtestᚋgraphᚋmodelᚐProduct(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalOProduct2ᚖhitrixᚑtestᚋgraphᚋmodelᚐProduct(ctx context.Context, sel ast.SelectionSet, v *model.Product) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
...
func (ec *executionContext) unmarshalOProductListInput2ᚖhitrixᚑtestᚋgraphᚋmodelᚐProductListInput(ctx context.Context, v interface{}) (*model.ProductListInput, error) {
	if v == nil {
		return nil, nil
	}
	res, err := ec.unmarshalInputProductListInput(ctx, v)
	return &res, graphql.ErrorOnPath(ctx, err)
}
